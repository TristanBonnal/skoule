<div class="container my-4"> <a href="<?= $router->generate('users-list') ?>" class="btn btn-success float-right">Retour</a>
    ...
    <form action="" method="POST" class="mt-5">
        ...
        <div class="form-group">
            ...
            <input type="email" class="form-control" name="email" id="email" placeholder="" value="<?= $_POST['email'] ?? '' ?>">
        </div>
        <div class="form-group">
            <label for="name">Nom</label>
            <input type="text" class="form-control" name="name" id="name" placeholder="" value="<?= $_POST['name'] ?? '' ?>">
        </div>
        <div class="form-group">
